...
// 第一种方式
        ...
        try {
            ...
            log.error("getPublicIP - getNowIP1 failed ~ ");
...
// 第二种方式
        ...
        try {
            ...
            log.error("getPublicIP - getNowIP2 failed ~ ");
...
// 第三种方式
        ...
        try {
            ...
            log.error("getPublicIP - getNowIP3 failed ~ ");
...
// 第四种方式
        ...
        try {
            ...
            log.error("getPublicIP - getNowIP4 failed ~ ");
